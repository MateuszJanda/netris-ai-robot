...
class FlatSigmoidModel:
    """
    Flat model with with more layers than FlatNN and sigmoid as activation for
    last layer.
    """
    ...
    def create_model(self):
        ...
        model.add(tf.keras.layers.Dense(units=config.ACTION_SPACE_SIZE, activation='sigmoid'))
